      ...
      <div className="relative top-20 mx-auto p-5 border border-gray-200 dark:border-white/10 w-96 shadow-lg rounded-2xl bg-white dark:bg-[#111B21]">
        <div className="mt-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Rule Name</label>
              <input
                type="text"
                required
                value={formData.name}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Trigger</label>
              <select
            ...
            {formData.trigger === 'KEYWORD' && (
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-white">Keyword</label>
                <input
                  type="text"
                  required
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white">Response Message</label>
              <textarea
                required
                rows={4}
